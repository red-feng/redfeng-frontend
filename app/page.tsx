...
const promoCards = [
  {
    ...
    overlayClass: "bg-[linear-gradient(90deg,rgba(255, 238, 232, 0.6)_0%,rgba(246, 92, 60, 0.52)_30%,rgba(140, 28, 24, 0.74)_100%)]",
  },
  {
    title: "Hotel Pilihan\nHarga Terbaik",
    eyebrow: "Diskon hingga",
    ...
    overlayClass: "bg-[linear-gradient(90deg,rgba(44, 58, 79, 0.62)_0%,rgba(25, 104, 214, 0.5)_30%,rgba(8, 41, 105, 0.74)_100%)]",
  },
  {
    ...
    overlayClass: "bg-[linear-gradient(90deg,rgba(233, 255, 247, 0.62)_0%,rgba(18, 147, 120, 0.5)_32%,rgba(6, 77, 67, 0.72)_100%)]",
  },
]

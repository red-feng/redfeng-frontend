...
const copy = {
  id: {
    ...
    sending: "Mengirim...",
    success: "Link reset password sudah dikirim. Cek email Anda dan buka tautannya untuk mengatur password baru.",
    back: "Kembali ke login",
    emptyEmail: "Email wajib diisi.",
  },
  en: {
    ...
    sending: "Sending...",
    success: "The password reset link has been sent. Please check your email and open the link to set a new password.",
    back: "Back to login",
  ...
  zh: {
    eyebrow: "密码重置",
    title: "发送重置链接",
    subtitle: "请输入您的账号邮箱。我们会发送一个链接供您设置新密码。",
    label: "账号邮箱",
    placeholder: "you@example.com",
    submit: "发送重置链接",
    sending: "发送中...",
...
export default function ForgotPasswordClient({ initialLocale }: { initialLocale: Locale }) {

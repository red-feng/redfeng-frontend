...
export default function Step4Itinerary({
  ...
  const addDay = () => {
    setDays((prev) => {
      ...
      return [...prev, createEmptyDay(nextIndex + 1)]
    })
  }
          ...
          <div className="w-full max-w-5xl rounded-3xl bg-white p-14 shadow-[0_20px_50px_rgba(0,0,0,0.15)]">
            ...
            <form action={saveItinerary} className="space-y-12">
              ...
              {days.map((day, dayIndex) => (
                <div key={dayIndex} className="rounded-2xl border bg-slate-50">
                  ...
                  <div className={expandedDayIndex === dayIndex ? "space-y-8 p-8" : "hidden"}>
                    <div className="flex flex-1 flex-col gap-3 md:flex-row md:items-center">
                      <h4 className="text-sm font-medium text-gray-600">{t.dayTitleLabel}</h4>
                      <input

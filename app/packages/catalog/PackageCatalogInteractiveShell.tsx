...
export default function PackageCatalogInteractiveShell({
  ...
  const scrollToSearch = () => {
    ...
    const headerOffset = typeof window !== "undefined" && window.innerWidth >= 1024 ? 96 : 64
  ...
  const stickyBar = shouldShowCompactStickyBar ? (
    <div className="fixed inset-x-0 top-[28px] z-[90] border-b border-[#f1ddd0] bg-[linear-gradient(180deg,#fffdfa_0%,#fff8f2_100%)] shadow-[0_22px_42px_-28px_rgba(15,23,42,0.24)] backdrop-blur-sm animate-[packageStickyDock_220ms_ease-out] lg:top-[44px]">

      ...
      <main className={`${homeLayoutLock.pageXClass} pb-14 pt-2 md:pt-3`}>
        <section className={`${homeLayoutLock.contentWidthClass} relative overflow-hidden ${homeLayoutLock.heroBackdropRadiusClass} bg-[#fff7ef] shadow-[0_40px_100px_-54px_rgba(249,115,22,0.34)]`}>
          <div className="relative min-h-[500px] px-4 pb-20 pt-[100px] sm:px-6 sm:pb-24 md:pt-[112px] lg:min-h-[560px] lg:px-8 xl:min-h-[600px]">
            <Image
              src="/home-assets/hero-kereta.png"
              alt="Train hero"
              fill
              priority
              sizes="100vw"
            ...
            />
            <div className="absolute inset-0 bg-[linear-gradient(90deg,rgba(248,250,252,0.985)_0%,rgba(241,245,249,0.94)_24%,rgba(219,234,254,0.52)_50%,rgba(255,255,255,0.12)_100%)]" />
            <div className="absolute inset-0 bg-[radial-gradient(circle_at_10%_16%,rgba(255,255,255,0.82),transparent_24%),radial-gradient(circle_at_24%_60%,rgba(191,219,254,0.22),transparent_28%),radial-gradient(circle_at_bottom_left,rgba(255,255,255,0.18),transparent_30%)]" />

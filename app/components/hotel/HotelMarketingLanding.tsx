      ...
      <main className={`${homeLayoutLock.pageXClass} pb-14 pt-2 md:pt-3`}>
        <section className={`${homeLayoutLock.contentWidthClass} relative overflow-visible ${homeLayoutLock.cardRadiusClass} bg-[#fff7ef] shadow-[0_40px_100px_-54px_rgba(249,115,22,0.34)]`}>
          <div className="relative min-h-[500px] px-4 pb-20 pt-[100px] sm:px-6 sm:pb-24 md:pt-[112px] lg:min-h-[560px] lg:px-8 xl:min-h-[600px]">
            <Image
              src="/home-assets/hero-hotel.png"
              alt="Hotel hero"
              fill
              priority
              sizes="100vw"
            ...
            />
            <div className="absolute inset-0 bg-[linear-gradient(90deg,rgba(255,252,245,0.985)_0%,rgba(255,249,235,0.94)_24%,rgba(254,243,199,0.52)_50%,rgba(255,247,237,0.12)_100%)]" />
            <div className="absolute inset-0 bg-[radial-gradient(circle_at_10%_16%,rgba(255,255,255,0.84),transparent_24%),radial-gradient(circle_at_24%_60%,rgba(125,211,252,0.18),transparent_28%),radial-gradient(circle_at_bottom_left,rgba(255,255,255,0.18),transparent_30%)]" />
        ...
        <section id="hotel-promo" className={`${homeLayoutLock.contentWidthClass} ${homeLayoutLock.cardRadiusSmClass} mt-10 rounded-[28px] border border-[#efe2d8] bg-[linear-gradient(180deg,#fff7f3_0%,#fffdfa_100%)] p-4 shadow-[0_26px_70px_-44px_rgba(15,23,42,0.18)] sm:p-6`}>
          <PromoPlacementImpressionBeacon placement={placementUsed || "homepage_feed"} sourcePath="/hotel" promos={promos.map((promo) => ({ id: promo.id, slug: promo.slug }))} />

...
export default function HomeServicesSection() {
  return (
    <section className="mx-auto -mt-0.5 max-w-[1240px] px-4 pb-5 pt-1 sm:px-6 lg:px-8">
      <div className="grid grid-cols-4 gap-3 sm:grid-cols-2 lg:grid-cols-7">
        {serviceCards.map((card) => {
          ...
          return (
            ...
            >
              <div className={`mx-auto flex h-11 w-11 items-center justify-center rounded-[16px] bg-white transition-transform duration-200 group-hover:scale-105 sm:h-14 sm:w-14 ${card.tone}`}>

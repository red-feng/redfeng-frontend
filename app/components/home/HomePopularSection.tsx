  ...
  return (
    <>
      ...
      <section className="mx-auto max-w-[1240px] px-4 pb-4 sm:px-6 lg:px-8">
        <div className="flex gap-3 overflow-x-auto pb-2 [-ms-overflow-style:none] [scrollbar-width:none] [&::-webkit-scrollbar]:hidden md:grid md:grid-cols-2 md:overflow-visible xl:grid-cols-5">
          {popularBookings.map((item) => (
            <article key={item.title} className="w-[138px] min-w-[138px] overflow-hidden rounded-[18px] border border-[#ebedf3] bg-white shadow-[0_20px_42px_-34px_rgba(15,23,42,0.2)] md:w-auto md:min-w-0">
              <div className="relative h-[112px] overflow-hidden md:h-[152px]">
              ...
              <div className="p-3.5 md:p-4">
                ...
                <h3 className="mt-3 text-[12px] font-bold tracking-[-0.03em] text-slate-900 md:text-[18px]">{item.title}</h3>

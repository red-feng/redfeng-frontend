          ...
          <div className="flex items-start gap-4">
            ...
            <div className="min-w-0 flex-1">
              <div className="flex items-start justify-between gap-3">
                <div>
                  <h3 className="text-[1.1rem] font-bold tracking-[-0.03em] text-slate-950">{appHomeConfig.featuredPromo.price}</h3>
                  <p className="mt-1 text-[14px] leading-5 text-slate-500">{appHomeConfig.featuredPromo.title.replace(/\n/g, " ")}</p>
                </div>
              ...
              <div className="mt-5 flex items-center gap-2 text-[12px] font-medium text-slate-500">
                ...
                {appHomeConfig.featuredPromo.badge ? <span className="rounded-full bg-slate-100 px-2 py-1 text-[11px] text-slate-500">{appHomeConfig.featuredPromo.badge}</span> : null}
              </div>
            </div>
          </div>
        </div>

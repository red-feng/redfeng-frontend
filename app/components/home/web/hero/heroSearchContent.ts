  ...
  flight: {
    ...
    variants: {
      one_way: {
        ...
        desktopGridClass: "hidden gap-5 lg:mt-6 lg:grid lg:grid-cols-[1.28fr_56px_1.28fr_1fr_1fr_1fr_84px] lg:items-start",
      ...
      round_trip: {
        ctaHref: `${serviceHref.flight}/catalog`,
        ctaLabel: "Lihat Katalog",
        desktopGridClass: "hidden gap-3 lg:mt-6 lg:grid lg:grid-cols-[1.14fr_44px_1.14fr_0.84fr_0.84fr_0.96fr_0.96fr_56px] lg:items-center",
        showDesktopSwap: true,
        desktopFields: [
          { label: "Dari", value: "CGK   Jakarta", sublabel: "Soekarno Hatta" },
          { label: "Ke", value: "SUB   Surabaya", sublabel: "Juanda" },
      ...
      multi_city: {
        ctaHref: `${serviceHref.flight}/catalog`,
        ctaLabel: "Lihat Katalog",
        desktopGridClass: "hidden gap-3 lg:mt-6 lg:grid lg:grid-cols-[1.02fr_1.02fr_1.02fr_0.84fr_0.94fr_0.94fr_56px] lg:items-center",
        desktopFields: [
  ...
  package: {
    ...
    variants: {
      domestic: {
        ...
        desktopGridClass: "hidden gap-3 lg:mt-6 lg:grid lg:grid-cols-[1.55fr_1fr_0.92fr_1fr_56px] lg:items-center",
        desktopFields: [
          { label: "Destinasi", value: "Indonesia", sublabel: "Negara tujuan" },
          { label: "Travel Style", value: "Family", sublabel: "Gaya perjalanan", withChevron: true },
          { label: "Durasi", value: "1-3 Hari", sublabel: "Durasi katalog", withChevron: true },
      ...
      international: {
        ...
        desktopGridClass: "hidden gap-3 lg:mt-6 lg:grid lg:grid-cols-[1.55fr_1fr_0.92fr_1fr_56px] lg:items-center",
        desktopFields: [
          { label: "Destinasi", value: "China", sublabel: "Negara tujuan" },
          { label: "Travel Style", value: "Luxury", sublabel: "Gaya perjalanan", withChevron: true },
          { label: "Durasi", value: "4-7 Hari", sublabel: "Durasi katalog", withChevron: true },
          { label: "Peserta", value: "2 Orang", sublabel: "Twin sharing", withChevron: true },
        ],
        mobilePrimaryCount: 1,
        mobileFields: [
      ...
      open_trip: {
        ...
        desktopGridClass: "hidden gap-3 lg:mt-6 lg:grid lg:grid-cols-[1.48fr_1fr_0.92fr_1fr_56px] lg:items-center",
        desktopFields: [
          { label: "Trip", value: "Indonesia", sublabel: "Negara tujuan" },
          { label: "Travel Style", value: "Open Trip", sublabel: "Gaya perjalanan", withChevron: true },
          { label: "Durasi", value: "1-3 Hari", sublabel: "Durasi katalog", withChevron: true },

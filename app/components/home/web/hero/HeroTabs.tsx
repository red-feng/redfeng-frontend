      ...
      {heroTabs.map((tab) => {
        ...
        return (
          <button
            ...
            className={`flex shrink-0 items-center gap-2 rounded-full border px-3 py-2 text-[12px] transition lg:border-b-[2.5px] lg:rounded-none lg:border-x-0 lg:border-t-0 lg:px-0 lg:py-2.5 lg:text-[14px] ${
              isActive

export const homeLayoutLock = {
  contentWidthClass: "mx-auto max-w-[1280px]",
  wideContentWidthClass: "mx-auto max-w-[1120px]",
  pageXClass: "px-4 sm:px-6 lg:px-8",
  heroShellClass: "relative mx-auto max-w-[1280px] px-5 pb-[5.25rem] pt-6 sm:px-6 lg:px-8",
  floatingSearchShellClass:
    "relative z-[220] mx-auto -mt-32 max-w-[1280px] overflow-visible px-4 pb-8 sm:-mt-36 sm:px-6 lg:-mt-[12.5rem] lg:px-8 lg:pb-10",

...
export const promoCards = [
  {
    ...
    overlayClass: "bg-[linear-gradient(90deg,rgba(133,72,104,0)_0%,rgba(167,101,129,0.06)_28%,rgba(208,132,145,0.34)_62%,rgba(239,165,144,0.88)_100%)]",
  ...
  },
  {
    ...
    overlayClass: "bg-[linear-gradient(90deg,rgba(25,88,192,0)_0%,rgba(39,108,211,0.06)_28%,rgba(59,133,233,0.32)_62%,rgba(28,92,191,0.86)_100%)]",
  ...
  },
  {
    ...
    overlayClass: "bg-[linear-gradient(90deg,rgba(18,140,154,0)_0%,rgba(25,156,166,0.06)_28%,rgba(82,192,173,0.3)_62%,rgba(28,109,121,0.84)_100%)]",

...
export default function AppHomeHeader() {
  return (
    <div className="relative overflow-hidden rounded-b-[52px] bg-[linear-gradient(180deg,#33b4f8_0%,#1ea0ec_52%,#138cde_100%)] px-3.5 pb-[6.25rem] pt-[calc(env(safe-area-inset-top)+1.2rem)] shadow-[0_26px_44px_-30px_rgba(13,136,221,0.56)]">
      ...
      <div className="relative z-10 flex items-center gap-2.5">
        <button
          type="button"
          className="flex h-[3.95rem] min-w-0 flex-1 items-center gap-3 overflow-hidden rounded-full bg-white/[0.06] px-5 text-left text-[#6a879d] ring-1 ring-white/50 shadow-[inset_0_1px_0_rgba(255,255,255,0.2)] backdrop-blur-[1.5px]"
        >
      ...
      <div className="relative z-10 pt-[0.95rem]">

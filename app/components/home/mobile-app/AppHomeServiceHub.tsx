...
export default function AppHomeServiceHub() {
  return (
    <div className="mx-4 -mt-2 rounded-[30px] bg-[linear-gradient(180deg,#ffffff_0%,#fffdfb_100%)] px-4 pb-5 pt-5 shadow-[0_24px_44px_-34px_rgba(15,23,42,0.2)] ring-1 ring-[#edf1f6]">

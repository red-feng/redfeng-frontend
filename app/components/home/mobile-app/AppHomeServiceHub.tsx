...
export default function AppHomeServiceHub() {
  return (
    <div className="relative z-10 mx-3.5 -mt-[6.25rem] rounded-[32px] bg-[linear-gradient(180deg,#ffffff_0%,#fffefe_100%)] px-4 pb-6 pt-[1.65rem] shadow-[0_28px_48px_-32px_rgba(15,23,42,0.2)] ring-1 ring-[#edf1f6]">

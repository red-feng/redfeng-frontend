      ...
      <div className={`relative transition-opacity duration-200 ${isPending ? "opacity-75" : "opacity-100"}`}>
        {isPending ? (
          <div className="pointer-events-none absolute inset-0 z-10 overflow-hidden rounded-[30px]">
            <div className="absolute inset-0 bg-white/38 backdrop-blur-[1px]" />
        ...
        <div className="rounded-[28px] border border-white/75 bg-white/88 p-3 shadow-[0_32px_60px_-34px_rgba(249,115,22,0.35)] backdrop-blur-xl sm:rounded-[30px] sm:p-4">
          <div className="grid gap-3 xl:grid-cols-[minmax(0,1.3fr)_auto]">
            <label className="group flex min-w-0 items-center gap-3 rounded-[24px] border border-[#f8d7c6] bg-white px-4 py-3.5 shadow-[0_16px_28px_-24px_rgba(15,23,42,0.28)] transition focus-within:border-orange-300 focus-within:ring-4 focus-within:ring-orange-100 sm:px-5 sm:py-4">
              <span className="flex h-11 w-11 shrink-0 items-center justify-center rounded-full bg-[#fff3ec] text-orange-500">
                <CountryIcon />
              </span>
              <span className="min-w-0 flex-1">
                ...
                <select
                  ...
                  disabled={isPending}
                  className="mt-1 w-full appearance-none bg-transparent text-[15px] font-semibold text-slate-900 outline-none sm:text-[16px]"
                >
            ...
            <button
              onClick={applyFilter}
              disabled={isPending}
              className="flex h-[70px] items-center justify-center gap-2 rounded-[24px] bg-gradient-to-r from-[#ff6934] via-[#ff5d2d] to-[#ef4423] px-6 text-[15px] font-semibold text-white shadow-[0_24px_38px_-24px_rgba(239,68,35,0.9)] transition hover:-translate-y-0.5 hover:from-[#ff5d2d] hover:to-[#ea3b1c] disabled:cursor-not-allowed disabled:opacity-70 xl:min-w-[150px]"
            >
              <SearchButtonIcon />
              <span>{isPending ? loadingLabel : submitLabel || t.apply}</span>
            </button>
          </div>

          <div className="mt-3 grid gap-3 md:grid-cols-3 xl:grid-cols-[minmax(0,1fr)_minmax(0,1fr)_auto]">
            <label className="group flex min-w-0 items-center gap-3 rounded-[22px] border border-[#f3dfd3] bg-[linear-gradient(180deg,#ffffff_0%,#fffaf6_100%)] px-4 py-3.5 shadow-[0_14px_24px_-24px_rgba(15,23,42,0.24)] transition focus-within:border-orange-300 focus-within:ring-4 focus-within:ring-orange-100">
            ...
            <div className="hidden rounded-[22px] border border-[#f3dfd3] bg-[linear-gradient(180deg,#fffaf6_0%,#fff4eb_100%)] px-5 py-3.5 text-right shadow-[0_14px_24px_-24px_rgba(15,23,42,0.24)] xl:block">
              <span className="block text-[10px] font-semibold uppercase tracking-[0.26em] text-slate-400">

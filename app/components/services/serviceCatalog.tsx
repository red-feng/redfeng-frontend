...
export const servicePageConfigs: ServicePageConfig[] = [
  {
    ...
    body: "Versi awal ini menutup menu layanan Pesawat agar user tidak mentok. Struktur dasarnya sudah siap untuk pencarian, promo, dan hasil live saat backend flight sudah terhubung.",
  ...
  },
  {
    ...
    title: "Paket Wisata sudah hidup penuh, jadi layanan ini langsung terhubung ke katalog utama RedFeng.",
    body: "Layanan ini memakai halaman katalog yang sudah ada. Kami tetap masukkan ke katalog layanan bersama supaya app dan website membaca tujuan yang sama.",
    highlights: ["Katalog paket aktif", "Filter dan hasil pencarian sudah tersedia", "Siap dipakai sebagai anchor untuk layanan lain"],
    primaryCta: { label: "Buka katalog paket", href: "/packages" },
    secondaryCta: { label: "Cari paket sekarang", href: "/search" },
    status: "Layanan aktif penuh dan sudah memakai katalog live.",

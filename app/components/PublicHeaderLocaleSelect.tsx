...
export default function PublicHeaderLocaleSelect({
  ...
  const baseClassName =
    mode === "currency"
      ? "min-h-[40px] appearance-none rounded-full bg-transparent py-2 pl-3 pr-8 text-sm font-medium text-white outline-none transition hover:bg-white/12 hover:text-[#ffd2c4]"
  ...
  return (
    <label className="relative block shrink-0">
      ...
      <span className={["pointer-events-none absolute inset-y-0 right-1 flex items-center", arrowClassName, iconClassName].filter(Boolean).join(" ")}>

...
function getFinanceLoginCopy(locale: Locale) {
  if (locale === "en") {
    return {
      heroEyebrow: "Red Feng Finance",
      heroTitle: "Secure access for the Red Feng finance workspace.",
      heroBody:
        "This page is dedicated to the internal team handling merchant payouts, disbursement verification, and payout cashflow monitoring.",
      bullets: [
        "Payout approval and transfer status control",
        "Monitoring outstanding and paid amounts",
        "Internal access for finance and finance manager",
      ],
      footer: "Not on the finance team? Use the admin, merchant, or customer portal based on your account role.",
      cardEyebrow: "Finance Login",
      cardTitle: "Sign in to finance dashboard",
      cardBody: "Use the internal username created by the finance manager.",
      backHome: "Back to homepage",
      usernameLabel: "Finance username",
      usernamePlaceholder: "e.g. finance.team",
      passwordLabel: "Password",
      passwordPlaceholder: "Enter finance password",
      passwordHint: "Reset through manager",
      submitIdle: "Enter finance dashboard",
      submitLoading: "Signing in...",
      noSession: "Your finance session has ended or was replaced. Please sign in again.",
      noProfile: "This internal account does not have a valid finance profile yet.",
      wrongPortalPrefix: "The finance portal only accepts finance or finance manager accounts.",
      emptyFields: "Username and password are required.",
      invalidCredentials: "Invalid finance username or password.",
      noAccess: "This account does not have finance access yet.",
      superadminOnly: "This portal is for finance and finance manager only. Please use the superadmin portal.",
      wrongRole: "This portal is for finance and finance manager only.",
    }
  }

  if (locale === "zh") {
    return {
      heroEyebrow: "Red Feng 财务",
      heroTitle: "为 Red Feng 财务工作台提供安全访问。",
      heroBody: "此页面仅供负责商家打款、放款核验和打款现金流监控的内部团队使用。",
      bullets: ["打款审批与转账状态控制", "监控待处理和已支付金额", "财务与财务经理的内部访问"],
      footer: "不是财务团队成员？请根据您的账号角色使用管理员、商家或客户入口。",
      cardEyebrow: "财务登录",
      cardTitle: "登录财务后台",
      cardBody: "请使用由财务经理创建的内部用户名。",
      backHome: "返回首页",
      usernameLabel: "财务用户名",
      usernamePlaceholder: "例如：finance.tim",
      passwordLabel: "密码",
      passwordPlaceholder: "输入财务密码",
      passwordHint: "通过经理重置",
      submitIdle: "进入财务后台",
      submitLoading: "登录中...",
      noSession: "您的财务会话已结束或被替换，请重新登录。",
      noProfile: "此内部账号尚未拥有有效的财务资料。",
      wrongPortalPrefix: "财务门户仅接受财务或财务经理账号。",
      emptyFields: "用户名和密码为必填项。",
      invalidCredentials: "财务用户名或密码无效。",
      noAccess: "此账号尚未拥有财务访问权限。",
      superadminOnly: "此入口仅限财务和财务经理使用。请改用超级管理员入口。",
      wrongRole: "此入口仅限财务和财务经理使用。",
    }
  }

  return {
    heroEyebrow: "Red Feng Finance",
    heroTitle: "Secure access untuk finance workspace Red Feng.",
    heroBody:
      "Halaman ini khusus untuk tim internal yang menangani payout merchant, verifikasi pencairan, dan monitoring arus dana payout.",
    bullets: [
    ...
    footer: "Bukan tim finance? Gunakan portal admin, merchant, atau customer sesuai peran akun Anda.",
    cardEyebrow: "Finance Login",
    cardTitle: "Masuk ke finance dashboard",
    cardBody: "Gunakan username internal yang dibuat oleh finance manager.",
    backHome: "Kembali ke beranda",
    usernameLabel: "Username finance",
    usernamePlaceholder: "mis: finance.tim",
    passwordLabel: "Password",
    passwordPlaceholder: "Masukkan password finance",
    passwordHint: "Reset lewat manager",
    submitIdle: "Masuk ke finance dashboard",
    ...
    invalidCredentials: "Username atau password finance tidak valid.",
    noAccess: "Akun ini belum memiliki akses finance.",
    superadminOnly: "Portal ini khusus untuk finance dan finance manager. Gunakan portal superadmin.",
    wrongRole: "Portal ini khusus untuk finance dan finance manager.",
  }
}
            ...
            <div className="rounded-[32px] border border-orange-100 bg-white p-8 shadow-[0_24px_70px_rgba(148,64,14,0.08)] sm:p-10">
              ...
              <div className="mt-8 space-y-6">
                <div className="space-y-3">
                  <label htmlFor="finance-username" className="text-sm font-semibold uppercase tracking-[0.22em] text-slate-500">
                    {t.usernameLabel}
                  </label>
                  <input
                    id="finance-username"
                ...
                <div className="space-y-3">
                  <label htmlFor="finance-password" className="text-sm font-semibold uppercase tracking-[0.22em] text-slate-500">
                    {t.passwordLabel}
                  </label>
                  <PasswordField
                    id="finance-password"

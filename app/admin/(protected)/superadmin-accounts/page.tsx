      ...
      <div className="mx-auto max-w-7xl space-y-8">
        ...
        <section className="grid gap-6 lg:grid-cols-[0.92fr_1.08fr]">
          <div className="space-y-6">
            ...
            >
              <input type="hidden" name="return_to" value="/admin/superadmin-accounts" />
            ...
            <div className="rounded-[32px] border border-violet-200/50 bg-white p-6 shadow-[0_24px_70px_rgba(15,23,42,0.08)]">
              ...
              <Link href="/admin/dashboard" className="mt-5 inline-flex text-sm font-semibold text-violet-700">

    ...
    >
      ...
      <div className="grid gap-5 xl:grid-cols-[1.2fr_0.8fr]">
        ...
        <div className="space-y-5">
          ...
          <div className="rounded-[20px] border border-orange-200 bg-orange-50 p-5 shadow-[0_14px_34px_rgba(249,115,22,0.08)]">
            <h2 className="text-base font-semibold text-slate-950">Auto-pilot Exception</h2>
            <p className="mt-2 text-sm leading-6 text-orange-800">
              Lihat booking yang tidak boleh dilepas otomatis: AirAsia, hold tertahan, payment paid belum issued, atau ticketing yang terlalu lama.
            </p>
            <Link
              href="/admin/pesawat/ops"

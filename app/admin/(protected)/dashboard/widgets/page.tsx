...
export default async function OperationsDashboardWidgetsPage({
  ...
  const activeCount = OPERATIONS_DASHBOARD_WIDGETS.filter((widget) => enabledWidgetKeys.has(widget.key)).length
      ...
      <div className="mx-auto max-w-[1280px] space-y-6">
        ...
        <section className="flex flex-col gap-4 xl:flex-row xl:items-start xl:justify-between">
          ...
          <div className="rounded-[18px] border border-[#eee3d9] bg-white px-5 py-4 shadow-[0_14px_34px_rgba(15,23,42,0.04)]">
            ...
            <p className="mt-1 text-xs text-slate-500">dari {OPERATIONS_DASHBOARD_WIDGETS.length} widget</p>
          </div>
        </section>

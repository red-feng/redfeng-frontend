    ...
    return {
      ...
      ...copy(
        locale,
        {
          ...
          body: "Red Feng sedang menerbitkan tiket ke supplier. Anda akan menerima e-ticket setelah proses selesai.",
          timelineLabel: "Tiket sedang diterbitkan",
        },
        {
          label: "Ticket is being issued",
          headline: "Payment received. Your ticket is being issued.",
          body: "Red Feng is issuing the ticket with the supplier. You will receive the e-ticket once it is complete.",
          timelineLabel: "Ticketing",
        },
        {
          label: "出票处理中",
          headline: "付款成功，机票正在出票。",
          body: "Red Feng 正在向供应商出票。出票完成后您将收到电子票。",
          timelineLabel: "出票处理中",
        },
      ),
    }
    ...
    return {
      ...
      ...copy(
        locale,
        {
          ...
          body: "Kami sedang memastikan penerbitan tiket ke supplier. Jika ada perubahan dari maskapai, tim Red Feng akan menghubungi Anda.",
        ...
        },
        {
          ...
          body: "We are confirming ticket issuance with the supplier. If the airline returns any change, the Red Feng team will contact you.",
          timelineLabel: "Under Red Feng review",
        },
        {
          label: "Red Feng 确认中",
          headline: "付款成功，Red Feng 正在确认机票。",
          body: "我们正在与供应商确认出票。如航空公司有任何变动，Red Feng 团队会联系您。",
    ...
    return {
      ...
      ...copy(
        locale,
        {
          ...
          body: "Payment Anda sudah terverifikasi. Red Feng akan menerbitkan tiket dan mengirim e-ticket setelah supplier mengonfirmasi.",
          timelineLabel: "Menunggu e-ticket",
        },
        {
          label: "Payment received",
          headline: "Payment received. Ticket issuance will start shortly.",
          body: "Your payment has been verified. Red Feng will issue the ticket and send the e-ticket after supplier confirmation.",
          timelineLabel: "Waiting for e-ticket",
        },
        {
          label: "付款成功",
          headline: "付款成功，即将出票。",
          body: "您的付款已验证。Red Feng 会在供应商确认后出票并发送电子票。",
          timelineLabel: "等待电子票",
        },
      ),
    }

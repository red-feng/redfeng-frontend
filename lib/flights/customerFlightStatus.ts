  ...
  if (lifecycle === "booking_hold_created" || lifecycle === "pending_payment") {
    if (input.holdExpired) {
      return {
        ...
        ...copy(
          locale,
          {
            label: "Perlu validasi ulang",
            headline: "Ketersediaan penerbangan perlu diperbarui.",
            body: "Batas validasi sebelumnya sudah lewat. Tim Red Feng akan memastikan ulang harga dan kursi sebelum pembayaran dibuka lagi.",
            timelineLabel: "Perlu validasi ulang",
          },
          {
            label: "Needs refresh",
            headline: "Flight availability needs to be refreshed.",
            body: "The previous validation window has passed. Red Feng will recheck price and seat availability before reopening payment.",
            timelineLabel: "Refresh needed",
          },
          {
            label: "需重新确认",
            headline: "航班信息需要更新。",
            body: "之前的确认时限已过。Red Feng 会重新确认价格和座位后再开放付款。",
            timelineLabel: "需重新确认",
          },
        ),
      }
    ...
    return {
      ...
      ...copy(
        ...
        {
          label: "Siap dibayar",
          headline: "Kursi berhasil diamankan. Pembayaran sudah bisa dilanjutkan.",
          body: "Harga dan kursi sudah dikonfirmasi. Selesaikan pembayaran sebelum batas waktu berakhir agar tiket bisa diterbitkan.",
          timelineLabel: "Siap dibayar",
        },
        {
          label: "Ready to pay",
          headline: "Your seat is secured. Payment is ready.",
          body: "Price and seat availability are confirmed. Complete payment before the time limit expires so the ticket can be issued.",
          timelineLabel: "Ready to pay",
        },
        {
          label: "可付款",
          headline: "座位已确认，可以付款。",
          body: "价格和座位已确认。请在时限前完成付款，以便出票。",
          timelineLabel: "可付款",
        },
      ),
    }
    ...
    return {
      ...
      ...copy(
        locale,
        {
          ...
          headline: "Booking diterima. Red Feng sedang memastikan harga dan ketersediaan kursi.",
          body: "Pembayaran belum dibuka agar harga dan kursi dipastikan terlebih dahulu.",
          timelineLabel: "Sedang divalidasi",
        },
        {
          label: "Being validated",
          headline: "Booking received. Red Feng is confirming price and seat availability.",
          body: "Payment is not opened yet so price and seat availability can be confirmed first.",
          timelineLabel: "Validation",
        },
        {
          label: "确认中",
          headline: "订单已收到，Red Feng 正在确认价格和座位。",

  ...
  const routeOverrides: Partial<FlightCatalogCardMeta> = (() => {
    if (item.id === "flight-cgk-sub") {
      return {
        ...
        price: "IDR 351.000",
        seatNote: locale === "en" ? "Verified on selected test dates" : locale === "zh" ? "已在指定测试日期验证" : "Terverifikasi pada tanggal uji tertentu",
        maxPassengers: 1,
        tripSupport: ["one_way", "round_trip"],
    ...
    if (item.id === "flight-sub-cgk") {
      return {
        ...
        transit: locale === "en" ? "Direct" : locale === "zh" ? "直飞" : "Langsung",
        price: "IDR 351.000",
        seatNote: locale === "en" ? "Verified on June 24, 2026" : locale === "zh" ? "已在 2026-06-24 验证" : "Terverifikasi pada 24 Juni 2026",
        maxPassengers: 1,
        tripSupport: ["one_way", "round_trip"],

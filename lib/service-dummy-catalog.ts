...
const extraDummyFlightItems: DummyCatalogItem[] = [
  ...
  {
    id: "flight-cgk-cgp",
    title: "Jakarta - Cirebon Express Link",
    location: "CGK - CGP",
    region: "Domestik",
    group: "Promo route",
    image: "/home-assets/card-flight.png",
    availabilityNote: "Dummy corridor baru untuk pasar sekunder Jawa Barat.",
    statusNote: "Bagus untuk uji filter region domestik dan keyword Cirebon.",
    highlights: ["Emerging corridor", "Price sensitive", "Weekend demand"],
    facts: [
      { label: "Route code", value: "CGK-CGP" },
      { label: "Cabin", value: "Economy" },
      { label: "Demand", value: "Weekend" },
    ],
  },
  {
    id: "flight-sri-btn",
    title: "Sriwijaya Link - Balikpapan Connector",
    location: "SRI - BPN",
    region: "Domestik",
    group: "Sekali jalan",
    image: "/home-assets/card-flight.png",
    availabilityNote: "Contoh konektor Kalimantan tengah untuk traffic regional.",
    statusNote: "Membantu tes region Kalimantan dan secondary origin-destination.",
    highlights: ["Regional connector", "Kalimantan route", "Midday"],
    facts: [
      { label: "Route code", value: "SRI-BPN" },
      { label: "Cabin", value: "Economy" },
      { label: "Window", value: "Afternoon" },
    ],
  },
  {
    id: "flight-cgk-bji-via-sby",
    title: "Jakarta - Jakarta Transit Explorer",
    location: "CGK - JKT",
    region: "Domestik",
    group: "Multi kota",
    image: "/home-assets/card-flight.png",
    availabilityNote: "Dummy multi-segment untuk uji query transit internal Jakarta.",
    statusNote: "Siap untuk memastikan filter transit-type menangani kota ganda.",
    highlights: ["Transit demo", "Multi-segment", "Internal link"],
    facts: [
      { label: "Route code", value: "CGK-JKT" },
      { label: "Cabin", value: "Premium Economy" },
      { label: "Transit", value: "Surabaya" },
    ],
  },
  {
    id: "flight-nrt-hkg",
    title: "Tokyo - Hong Kong Premium Connector",
    location: "NRT - HKG",
    region: "Internasional",
    group: "Business",
    image: "/home-assets/promo-flight.png",
    availabilityNote: "Dummy long-haul Asia Timur untuk segmen bisnis premium.",
    statusNote: "Cocok untuk tes filter cabin Business di luar rute Indonesia-origin.",
    highlights: ["Premium tier", "Asia East hub", "Business class"],
    facts: [
      { label: "Route code", value: "NRT-HKG" },
      { label: "Cabin", value: "Business" },
      { label: "Use case", value: "Premium" },
    ],
  },
  {
    id: "flight-dps-cgn-via-sin",
    title: "Bali - Cologne via Singapore Explorer",
    location: "DPS - CGN",
    region: "Internasional",
    group: "Multi kota",
    image: "/home-assets/promo-flight.png",
    availabilityNote: "Dummy long-haul Eropa dari Bali via transit Singapore.",
    statusNote: "Bagus untuk cek route multi-segment internasional dari Bali.",
    highlights: ["Europe link", "Via Singapore", "Long haul"],
    facts: [
      { label: "Route code", value: "DPS-SIN-CGN" },
      { label: "Cabin", value: "Economy" },
      { label: "Transit", value: "Singapore" },
    ],
  },
  {
    id: "flight-sin-cmb",
    title: "Singapore - Colombo Leisure Route",
    location: "SIN - CMB",
    region: "Internasional",
    group: "Promo route",
    image: "/home-assets/promo-flight.png",
    availabilityNote: "Dummy South Asia dari hub Singapore untuk promo travel.",
    statusNote: "Membantu variasi keyword Singapore-origin di luar Indonesia.",
    highlights: ["South Asia promo", "Holiday demand", "Budget-friendly"],
    facts: [
      { label: "Route code", value: "SIN-CMB" },
      { label: "Cabin", value: "Economy" },
      { label: "Demand", value: "Holiday" },
    ],
  },
  {
    id: "flight-cgk-bue-via-fra",
    title: "Jakarta - Buenos Aires Transcontinental Dummy",
    location: "CGK - BUE",
    region: "Internasional",
    group: "Pulang pergi",
    image: "/home-assets/promo-flight.png",
    availabilityNote: "Dummy transkontinental untuk uji range harga jauh dan transit ganda.",
    statusNote: "Siap untuk cek sorting harga extreme dan transit multi-point.",
    highlights: ["Transcontinental", "Longest route", "Return ready"],
    facts: [
      { label: "Route code", value: "CGK-FRA-BUE" },
      { label: "Cabin", value: "Premium Economy" },
      { label: "Trip type", value: "Round-trip" },
    ],
  },
  {
    id: "flight-sub-jog",
    title: "Surabaya - Yogyakarta Heritage Shuttle",
    location: "SUB - JOG",
    region: "Domestik",
    group: "Pulang pergi",
    image: "/home-assets/card-flight.png",
    availabilityNote: "Dummy corridor Jawa tengah-selatan untuk traffic budaya.",
    statusNote: "Bagus untuk region Jawa dan route heritage tourism.",
    highlights: ["Javanese heritage", "Short hop", "Weekend return"],
    facts: [
      { label: "Route code", value: "SUB-JOG" },
      { label: "Cabin", value: "Economy" },
      { label: "Window", value: "Morning" },
    ],
  },
  {
    id: "flight-cgk-dps-premium",
    title: "Jakarta - Denpasar Premium Cabin Lane",
    location: "CGK - DPS",
    region: "Domestik",
    group: "Sekali jalan",
    image: "/home-assets/promo-flight.png",
    availabilityNote: "Dummy lane premium untuk uji variasi cabin di koridor leisure favorit.",
    statusNote: "Siap dipakai untuk tes filter cabin dan segmentasi traveler high-spender.",
    highlights: ["Premium cabin", "Leisure hotspot", "Midday wave"],
    facts: [
      { label: "Route code", value: "CGK-DPS" },
      { label: "Cabin", value: "Business" },
      { label: "Window", value: "Midday" },
    ],
  },
  {
    id: "flight-cgk-bkk-aug",
    title: "Jakarta - Bangkok Weekday Saver",
    location: "CGK - BKK",
    region: "Internasional",
    group: "Sekali jalan",
    image: "/home-assets/promo-flight.png",
    availabilityNote: "Contoh rute regional business saver yang padat di awal pekan.",
    statusNote: "Bisa dipakai untuk simulasi search regional ASEAN dan rule promo weekday.",
    highlights: ["Weekday saver", "ASEAN regional", "Business demand"],
    facts: [
      { label: "Route code", value: "CGK-BKK" },
      { label: "Cabin", value: "Economy" },
      { label: "Window", value: "Morning" },
  ...
  {
    id: "flight-dps-sin-ritase",
    title: "Bali - Singapore Ritase Slot",
    location: "DPS - SIN",
    region: "Internasional",
    group: "Promo route",
    image: "/home-assets/promo-flight.png",
    availabilityNote: "Dummy ritase DPS-SIN untuk simulasi demand weekend dan business mix.",
    statusNote: "Membantu eksplorasi filter region internasional dan segmentasi ritase pendek.",
    highlights: ["Short international", "Weekend demand", "Mixed audience"],
    facts: [
      { label: "Route code", value: "DPS-SIN" },
      { label: "Cabin", value: "Economy" },
  ...
  {
    id: "flight-cgk-hnd-red-eye",
    title: "Jakarta - Tokyo Red-Eye Connector",
    location: "CGK - HND",
    region: "Internasional",
    group: "Sekali jalan",
    image: "/home-assets/promo-flight.png",
    availabilityNote: "Contoh rute long-haul Jepang dengan departure malam untuk koridor premium.",
    statusNote: "Disiapkan untuk menguji window malam, durasi panjang, dan harga long-haul.",
    highlights: ["Red-eye departure", "Long-haul", "Japan inbound"],
    facts: [
      { label: "Route code", value: "CGK-HND" },
      { label: "Cabin", value: "Economy" },
      { label: "Window", value: "Night" },
    ],
  },
  {
    id: "flight-cgk-dps-family",
    title: "Jakarta - Denpasar Family Round-Trip",
    location: "CGK - DPS",
    region: "Domestik",
    group: "Pulang pergi",
    image: "/home-assets/promo-flight.png",
    availabilityNote: "Dummy round-trip keluarga untuk simulasi plan liburan multi-tiket.",
    statusNote: "Cocok untuk tes passenger count keluarga dan rule multi-ticket round-trip.",
    highlights: ["Family plan", "Round-trip ready", "Holiday demand"],
    facts: [
      { label: "Route code", value: "CGK-DPS" },
      { label: "Trip type", value: "Round-trip" },
      { label: "Demand", value: "Family" },
    ],
  },
  {
    id: "flight-sub-bdo-sumatra",
    title: "Surabaya - Bandung Domestic Short-Hop",
    location: "SUB - BDO",
    region: "Domestik",
    group: "Sekali jalan",
    image: "/home-assets/card-flight.png",
    availabilityNote: "Dummy short-hop Jawa untuk trafik antar kota bisnis menengah.",
    statusNote: "Berguna untuk validasi window siang dan segmentasi koridor Jawa Barat.",
    highlights: ["Short domestic", "Afternoon wave", "Mid-tier city"],
    facts: [
      { label: "Route code", value: "SUB-BDO" },
      { label: "Cabin", value: "Economy" },
      { label: "Window", value: "Afternoon" },
    ],
  },
